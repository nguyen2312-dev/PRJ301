...
public class mainController extends HttpServlet {
    ...
    private static final String LOGOUT_CONTROLLR = "LogOutServlet";
    private static final String DELETE_CONTROLLER = "DeleteHomestaysServlet";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                } else if (button != null && session != null && session.getAttribute("LOGIN_INFO") != null) {
                    switch (button) {
                        case "Search":
                            url = SEARCH_CONTROLLER;
                            break;
                        case "Logout":
                            url = LOGOUT_CONTROLLR;
                            break;
                        case "Delete":
